    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("user", models.ForeignKey(on_delete=models.deletion.CASCADE, related_name="verification_requests", to="users.user")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("user", models.OneToOneField(on_delete=models.deletion.CASCADE, related_name="premium_subscription", to="users.user")),
            ],
